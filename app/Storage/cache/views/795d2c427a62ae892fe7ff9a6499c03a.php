...
<body class="bg-gradient-to-br from-gray-900 to-gray-800 min-h-screen flex items-center justify-center">
    <div class="text-center">
        ...
        <p class="mt-8 text-gray-500 text-sm">
            ...
            <a href="<?php echo e($base_url); ?>/docs" class="text-cyan-400 hover:underline">documentation</a>
        </p>
    </div>
</body>
</html><?php /**PATH /home/user/Kiwkiw-Native/app/View/error/error404.blade.php ENDPATH**/ ?>