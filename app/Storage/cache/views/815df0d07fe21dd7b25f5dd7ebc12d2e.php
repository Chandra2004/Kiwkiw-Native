...
<body class="bg-gradient-to-br from-gray-900 to-gray-800 min-h-screen">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-16 items-center">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <a href="https://github.com/Chandra2004/Kiwkiw-Native.git" target="_blank"
    ...
    <main class="pt-32 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div class="mb-8">
            <a href="<?php echo e(url('/')); ?>" class="text-cyan-400 hover:text-cyan-300 flex items-center gap-2">
        ...
        <?php if(!empty($error) || (!empty($_GET['status']) && !empty($_GET['message']))): ?>
            <div class="alert mb-8 p-4 rounded-lg border border-<?php echo e(!empty($error) ? 'red-500/30' : ($_GET['status'] == 'success' ? 'cyan-500/30' : 'red-500/30')); ?> bg-gradient-to-r from-gray-800/50 to-gray-900/50 backdrop-blur-sm relative overflow-hidden transition-all duration-300">
                <!-- Gradient accent bar -->
                <div
                    class="absolute left-0 top-0 h-full w-1.5 bg-gradient-to-b from-<?php echo e(!empty($error) ? 'red-500' : ($_GET['status'] == 'success' ? 'cyan-500' : 'red-500')); ?> to-<?php echo e(!empty($error) ? 'pink-600' : ($_GET['status'] == 'success' ? 'blue-600' : 'pink-600')); ?>">
                </div>

                <div class="flex items-start gap-3 pl-4">
                    <!-- Icon -->
                    <div class="flex-shrink-0">
                        <?php if(!empty($error) || $_GET['status'] != 'success'): ?>
                    ...
                    <div class="flex-1">
                        <h3
                            class="text-sm font-semibold text-<?php echo e(!empty($error) ? 'red-400' : ($_GET['status'] == 'success' ? 'cyan-400' : 'red-400')); ?> mb-1">
                            <?php echo e(!empty($error) ? 'Error' : ucfirst($_GET['status'])); ?>

                        </h3>
                        <p class="text-sm text-gray-300 leading-tight">
                            <?php echo e(!empty($error) ? $error : $_GET['message']); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <?php if(!empty($userData)): ?>
                <?php $__currentLoopData = $userData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $userItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(url('user/information/' . $userItem['id'])); ?>"
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-gray-400 text-sm">
                                    Member since <?php echo e($userItem['created_at']); ?>
        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            <div class="relative bg-gray-800 rounded-xl border border-gray-700/50 shadow-2xl overflow-hidden">
                ...
                <div class="py-6 px-6 lg:px-8">
                    <form class="space-y-6" action="<?php echo e(url('user')); ?>" method="POST"
...
<?php /**PATH /home/user/Kiwkiw-Native/app/View/interface/user.blade.php ENDPATH**/ ?>