    ...
    <main class="pt-32 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div class="max-w-3xl mx-auto">
            <div class="mb-8 flex items-center justify-between">
                <a href="<?php echo e(url('user')); ?>" class="text-cyan-400 hover:text-cyan-300 flex items-center gap-2">
            ...
            <div class="bg-gray-800/50 p-8 rounded-2xl border border-gray-700/50">
                ...
                <form action="<?php echo e(url('user/' . $user['id'] . '/update')); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                            ...
                            <a href="<?php echo e(url('user/' . $user['id'] . '/delete')); ?>" onclick="return confirm('Are you sure you want to delete this user?');" class="text-sm font-medium text-red-800 group-hover:text-cyan-400 transition-colors">hapus <?php echo e($user['name']); ?></a>
                        </div>
                        <div>
                            <p class="text-gray-400 text-sm mb-1">Username</p>
                            <p class="text-gray-100 font-medium"><?php echo e($user['name']); ?></p>
                        </div>
                        <div>
                            <ul>
                                <li>
                        ...
                        <div>
                            ...
                            <img src="<?php echo e($user['profile_picture'] ? url('file.php?file=' . $user['profile_picture']) : url('file.php?file=dummy/dummy.jpg')); ?>" alt="<?php echo e($user['name']); ?>" loading="lazy">
                        </div>
                    </div>
        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            <div class="relative bg-gray-800 rounded-xl border border-gray-700/50 shadow-2xl overflow-hidden">
                ...
                <div class="py-6 px-6 lg:px-8">
                    <form class="space-y-6" action="<?php echo e(url('user')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo '<input type="hidden" name="_token" value="' . $_SESSION['csrf_token'] . '">'; ?>
                        <!-- Name Input -->
                        <div class="relative group">
                            <div class="absolute inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none text-cyan-400">
...
</html><?php /**PATH /home/user/Kiwkiw-Native/app/View/interface/detail.blade.php ENDPATH**/ ?>